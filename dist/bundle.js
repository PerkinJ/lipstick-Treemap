...
var Lipstick_1 = __webpack_require__(175);
ReactDOM.render(React.createElement(Lipstick_1.Lipstick, { title: "\u53E3\u7EA2\u53EF\u89C6\u5316\u2014\u2014TreeMap\u7248\u672C" }), document.getElementById("example"));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(50);
var Treemap_1 = __webpack_require__(176);
var lipstick = __webpack_require__(469);
var Lipstick = /** @class */ (function (_super) {
    __extends(Lipstick, _super);
    function Lipstick() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    Lipstick.prototype.render = function () {
        return React.createElement("div", { style: { margin: '30px auto', width: '980px' } },
            React.createElement("h1", { style: { textAlign: 'center', color: '#fff' } }, this.props.title),
            React.createElement("div", { style: { height: '600px', boxShadow: ' 0px 0px 25px 10px #EF94AD' } },
                React.createElement(Treemap_1.default, { width: 980, height: 600, value: "value", data: lipstick })));
    };
    return Lipstick;
}(React.Component));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(50);
var d3 = __webpack_require__(177);
var Treemap = /** @class */ (function (_super) {
    ...
    function Treemap(props) {
            ...
            if (data.hasOwnProperty('children')) {
                ...
                for (var i = 0; i < data1.length; i++) {
                    if (data1[i].hasOwnProperty('children')) {
                        ...
                        for (var i_1 = 0; i_1 < data2.length; i_1++) {
                            if (data2[i_1].hasOwnProperty('children')) {
                                var data3 = data2[i_1].children;
                                for (var i_2 = 0; i_2 < data3.length; i_2++) {
                                    data3[i_2].value = 300;
                                }
                            }
                        }
        ...
        _this.sumBySize = function (d) { return d[_this.props.value]; };
        return _this;
    }
    Treemap.prototype.render = function () {
        var _a = this.props, data = _a.data, width = _a.width, height = _a.height, paddingInner = _a.paddingInner;
        var treeData = this.handleData(data);
        var fader = function (color) { return d3.interpolateRgb(color, "#fff")(0.2); }, color = d3.scaleOrdinal(d3.schemeCategory10.map(fader)), format = d3.format(",d");
        ...
        if (JSON.stringify(data) !== '{}') {
            var root = d3.hierarchy(treeData)
                .eachBefore(function (d) { return d.data.id = (d.parent ? d.parent.data.id + "." : "") + d.data.name; })
                .sum(this.sumBySize)
                .sort(function (a, b) { return b.height - a.height || b.value - a.value; });
            treemap(root);
            treemapData = root.leaves();
        }
        return (React.createElement("svg", { width: width, height: height, style: { fontSize: 10 } }, treemapData.length > 0 && treemapData.map(function (d, index) {
            return (React.createElement("g", { key: index, transform: "translate(" + d.x0 + "," + d.y0 + ")" },
                React.createElement("rect", { id: d.data.id, width: d.x1 - d.x0, height: d.y1 - d.y0, fill: d.data.color }),
                React.createElement("text", { clipPath: "url(#clip-" + d.data.id + ")" },
                    React.createElement("tspan", { x: 4, y: 12 }, d.data.name.split(/(?=[A-Z][^A-Z])/g))),
                React.createElement("title", null, d.data.id)));
        })));
    };
